...
const HeroSection = () => {
  return (
    <section className="lg:py-16">
      ...
      repeat={Infinity}
    /></h1>
          <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl"> a student at PeTIK II Jombang.</p>
          <div>
            ...
            <Link href="/"className="px-1 inline-block py-1 w-full sm:w-fit rounded-full bg-gradient-to-br from-primary-500 to-secondary-500 hover:bg-slate-800 text-white mt-3">
                <span className="block bg-[#121212] hover:bg-slate-800 rounded-full px-5 py-2">Dwonload CV</span>
                </Link>
          </div>
          </motion.div>
          <motion.div
